                            ...
                            <button
                                ...
                                onClick={() => {
                                    window.location.href =
                                        "https://forms.gle/CuvZS52XrtPbkm6q7";
                                }}
                            >
...
export default function Events(props) {
    ...
    return (
        <section
            className={`flex flex-col justify-start items-center h-auto max-[850px]:gap-10 ${props?.className} pb-10 md:py-0`}
            id="events"
            ref={sectionRef}
        >
            <div className="h-screen border-white border-2- flex justify-center items-center w-[70%] gap-16 max-[1024px]:w-[70%] max-[850px]:w-[60%] max-[720px]:w-[80%] max-[530px]:w-[90%] max-[280px]:w-[95%] max-[850px]:h-max lg:mt-28">
                ...
                >
                    ...
                    <p className="text-justify text-lg flex-[0.3] max-[1175px]:text-md max-[1175px]:leading-5 max-[850px]:hidden">
                        Symphony conducts a variety of events and competitions
                        ranging from celebrity pro-shows to music, dance, art,
                        creative writing, debating, drama and
                    ...
                    <p className="text-justify text-lg flex-[0.3] max-[1175px]:text-md max-[1175px]:leading-5 max-[280px]:text-sm max-[850px]:text-[1rem] max-[850px]:pb-6">
                        <span className="min-[850px]:hidden">
                            These diverse events and competitions provide a
                            platform for participants to showcase their talents,
                            engage in friendly rivalry, and foster a vibrant
                            cultural exchange
                        </span>
                        These diverse events and competitions provide a platform
                        for participants to showcase their talents, engage in
                        friendly rivalry, and foster a vibrant cultural exchange
                    </p>
                </div>
            </div>

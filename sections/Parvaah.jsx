            ...
            <div className="h-screen border-white border-2- flex justify-center items-center w-[70%] gap-16 max-[1024px]:w-[70%] max-[850px]:w-[60%] max-[720px]:w-[80%] max-[530px]:w-[90%] max-[280px]:w-[95%] max-[850px]:h-max lg:mt-28">
                ...
                >
                    ...
                    <p className="text-justify text-lg flex-[0.3] max-[1175px]:text-md max-[1175px]:leading-5 max-[850px]:hidden">
                        Parvaah is the social initiative of K J Somaiya College
                        of Engineering and works towards the betterment of the
                        society full of enthusiasm and dignity. It undertakes
                        various initiatives like donation drives, beach
                        clean-ups, orphanage visits, etc.
                    </p>
                    <div
                    ...
                    <p className="text-justify text-lg flex-[0.3] max-[1175px]:text-md max-[1175px]:leading-5 max-[280px]:text-sm max-[850px]:text-[1rem] max-[850px]:pb-6">
                        <span className="min-[850px]:hidden">
                            After 3 impactful years, Team Parvaah focuses on
                            environmental sustainability, championing
                            "Sustainable Reality" through diverse events and
                            outreach to promote key sustainability concepts.
                        </span>
                        After 3 impactful years, Team Parvaah focuses on
                        environmental sustainability, championing "Sustainable
                        Reality" through diverse events and outreach to promote

...
const ComingSoon = () => {
  ...
  return (
    <div className="h-screen z-0 flex items-center justify-center">
      <div className="relative py-16 flex justify-center items-center flex-col gap-6 md:gap-5 w-[90%] md:w-[80%] bg-[radial-gradient(62.49%_50%_at_50%_50%,#1F1F1F_0%,#0B0B0B_100%)] border-[1px] rounded-[9px] border-[#ffbf00]">
        ...
        Experience an enchanting royal celebration! Delight in the majestic festivities and unforgettable memories!
        </h3>
      </div>
    </div>
  );

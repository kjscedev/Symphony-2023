                            ...
                            <button
                                ...
                                onClick={() => {
                                    ...
                                    window.location.href =
                                        "https://forms.gle/cnjHb84aQkM3hS769";
                                }}
                            >
            ...
            <div className="h-screen border-white border-2- flex justify-center items-center w-[70%] gap-16 max-[1024px]:w-[70%] max-[850px]:w-[60%] max-[720px]:w-[80%] max-[530px]:w-[90%] max-[280px]:w-[95%] max-[850px]:h-max lg:mt-28">
                ...
                >
                    ...
                    <p className="text-justify text-lg flex-[0.3] max-[1175px]:text-md max-[1175px]:leading-5 max-[850px]:hidden">
                        KJSCE Shield comprises of the Technical Shield, Indoor
                        and Outdoor Sports Shield and the Cultural Shield.
                        Throughout the year, all the five branches compete
                        against each other to prove their mettle and claim the
                    ...
                    <p className="text-justify text-lg flex-[0.3] max-[1175px]:text-md max-[1175px]:leading-5 max-[280px]:text-sm max-[850px]:text-[1rem] max-[850px]:pb-6">
                        <span className="min-[850px]:hidden">
                            While the indoor shield and the Outdoor shield takes
                            place throughout the year, the technical shield
                            takes place during Abhiyantriki and the Cultural
                            Shield during Symphony.
                        </span>
                        While the indoor shield and the Outdoor shield takes
                        place throughout the year, the technical shield takes
                        place during Abhiyantriki and the Cultural Shield during
                        Symphony.
                    </p>
                </div>
            </div>
